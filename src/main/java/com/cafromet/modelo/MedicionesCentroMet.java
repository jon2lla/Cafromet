...
public class MedicionesCentroMet implements java.io.Serializable {
	...
	public MedicionesCentroMet(MedicionesCentroMetId id, CentrosMeteorologicos centrosMeteorologicos, Float comgm3,
			Float co8hmgm3, Float nogm3, Float no2, String no2ica, Float noxgm3, Float pm10, String pm10ica, Float pm25,
			String pm25ica, Float so2, String so2ica, String icaEstacion) {
		this.id = id;
		this.centrosMeteorologicos = centrosMeteorologicos;
		this.comgm3 = comgm3;
